...
{
    [Serializable]
    public class OfflineUretimPerformansKullanici
    {
        public List<OfflineUretimPerformansKullaniciProcedureModel> performansList { get; set; }
    }
    public class OfflineUretimPerformansKullaniciProcedureModel
    {
