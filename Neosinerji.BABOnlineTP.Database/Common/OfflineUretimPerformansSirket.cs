...
{
    [Serializable]
    public class OfflineUretimPerformansSirket
    {
        public List<OfflineUretimPerformansSirketProcedureModel> performansList { get; set; }
    }
    public class OfflineUretimPerformansSirketProcedureModel
    {
        public int donem { get; set; }
        public int tumkodu { get; set; }
        public int branskodu { get; set; }
        public int TUMBirlikKodu { get; set; }
