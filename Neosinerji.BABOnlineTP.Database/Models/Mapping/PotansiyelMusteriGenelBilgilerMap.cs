...
{
    public class PotansiyelMusteriGenelBilgilerMap : EntityTypeConfiguration<PotansiyelMusteriGenelBilgiler>
    {
        public PotansiyelMusteriGenelBilgilerMap()
        {
            // Primary Key
            this.HasKey(t => t.PotansiyelMusteriKodu);
            ...
            this.ToTable("PotansiyelMusteriGenelBilgiler");
