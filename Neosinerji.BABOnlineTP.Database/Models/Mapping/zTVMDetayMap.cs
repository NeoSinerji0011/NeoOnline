...
{
    public class zTVMDetayMap : EntityTypeConfiguration<zTVMDetay>
    {
        public zTVMDetayMap()
        {
            // Primary Key
            this.HasKey(t => new { t.Kodu, t.Unvani, t.Tipi, t.KayitNo, t.VergiDairesi, t.VergiNumarasi, t.Profili, t.BagliOlduguTVMKodu, t.AcentSuvbeVar, t.Durum, t.BolgeKodu, t.SifreKontralSayisi, t.SifreDegistirmeGunu, t.SifreIkazGunu, t.BaglantiSiniri });
            ...
            this.Property(t => t.BagliOlduguTVMKodu)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);
            ...
            this.Property(t => t.SifreKontralSayisi)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);

            this.Property(t => t.SifreDegistirmeGunu)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);

            this.Property(t => t.SifreIkazGunu)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);
