...
{
    public class PoliceAracMap : EntityTypeConfiguration<PoliceArac>
    {
        public PoliceAracMap()
        {
            // Primary Key
            ...
            this.Property(t => t.MarkaAciklama)
                .HasMaxLength(250);

            this.Property(t => t.AracinTipiKodu)
                .HasMaxLength(25);

            this.Property(t => t.AracinTipiAciklama)
                .HasMaxLength(250);

            this.Property(t => t.AracinTipiKodu2)
                .HasMaxLength(25);

            this.Property(t => t.AracinTipiAciklama2)
                .HasMaxLength(250);
            ...
            this.Property(t => t.MarkaAciklama).HasColumnName("MarkaAciklama");
            this.Property(t => t.AracinTipiKodu).HasColumnName("AracinTipiKodu");
            this.Property(t => t.AracinTipiAciklama).HasColumnName("AracinTipiAciklama");
            this.Property(t => t.AracinTipiKodu2).HasColumnName("AracinTipiKodu2");
            this.Property(t => t.AracinTipiAciklama2).HasColumnName("AracinTipiAciklama2");
