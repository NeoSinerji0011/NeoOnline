...
{
    public class PotansiyelMusteriAdreMap : EntityTypeConfiguration<PotansiyelMusteriAdre>
    {
        public PotansiyelMusteriAdreMap()
        {
            // Primary Key
            ...
            this.ToTable("PotansiyelMusteriAdres");
            ...
            this.HasRequired(t => t.PotansiyelMusteriGenelBilgiler)
                .WithMany(t => t.PotansiyelMusteriAdres)
