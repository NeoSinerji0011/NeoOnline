...
{
    public class Z_2014TeklifAracMap : EntityTypeConfiguration<Z_2014TeklifArac>
    {
        public Z_2014TeklifAracMap()
        {
            // Primary Key
            this.HasKey(t => t.TableTeklifAracId);
            ...
            this.ToTable("Z_2014TeklifArac");
            this.Property(t => t.TableTeklifAracId).HasColumnName("TableTeklifAracId");
