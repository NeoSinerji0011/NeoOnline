...
{
    public class Z_2014TeklifGenelMap : EntityTypeConfiguration<Z_2014TeklifGenel>
    {
        public Z_2014TeklifGenelMap()
        {
            // Primary Key
            this.HasKey(t => t.TeklifId);

            // Properties
            this.Property(t => t.TableTeklifId)
            ...
            this.ToTable("Z_2014TeklifGenel");
            this.Property(t => t.TableTeklifId).HasColumnName("TableTeklifId");
