...
{
    public class TeklifGenelMap : EntityTypeConfiguration<TeklifGenel>
    {
        public TeklifGenelMap()
        {
            // Primary Key
            ...
            this.Property(t => t.KaydiEKleyenTVMKodu).HasColumnName("KaydiEKleyenTVMKodu");
            this.Property(t => t.KaydiEKleyenTVMKullaniciKodu).HasColumnName("KaydiEKleyenTVMKullaniciKodu");
            this.Property(t => t.iptal).HasColumnName("iptal");

            // Relationships
            this.HasRequired(t => t.TVMDetay)
                .WithMany(t => t.TeklifGenels)
