...
{
    public class MusteriGenelBilgilerMap : EntityTypeConfiguration<MusteriGenelBilgiler>
    {
        public MusteriGenelBilgilerMap()
        {
            // Primary Key
            ...
            this.Property(t => t.MuhasebeKodu)
                .HasMaxLength(100);
            ...
            this.ToTable("MusteriGenelBilgiler");
            ...
            this.Property(t => t.MuhasebeKodu).HasColumnName("MuhasebeKodu");
