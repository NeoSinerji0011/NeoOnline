...
{
    public class PoliceSigortaEttirenMap : EntityTypeConfiguration<PoliceSigortaEttiren>
    {
        public PoliceSigortaEttirenMap()
        {
            // Primary Key
            ...
            this.ToTable("PoliceSigortaEttiren");
            ...
            this.Property(t => t.DainiMurtehinSubeAdi).HasColumnName("DainiMurtehinSubeAdi");
            

            // Relationships
            this.HasRequired(t => t.PoliceGenel)
                .WithOptional(t => t.PoliceSigortaEttiren);
