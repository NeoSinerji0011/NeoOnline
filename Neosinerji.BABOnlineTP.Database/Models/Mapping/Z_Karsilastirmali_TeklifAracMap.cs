...
{
    public class Z_Karsilastirmali_TeklifAracMap : EntityTypeConfiguration<Z_Karsilastirmali_TeklifArac>
    {
        public Z_Karsilastirmali_TeklifAracMap()
        {
            // Primary Key
            this.HasKey(t => t.TeklifAracId);

            // Properties
            this.Property(t => t.TeklifAracId)
            ...
            this.ToTable("Z_Karsilastirmali_TeklifArac");
