...
{
    public partial class MusteriGenelBilgiler
    {
        public MusteriGenelBilgiler()
        {
            this.MusteriAdres = new List<MusteriAdre>();
            this.MusteriDokumen = new List<MusteriDokuman>();
            this.MusteriNots = new List<MusteriNot>();
            this.MusteriTelefons = new List<MusteriTelefon>();
        ...
        public virtual ICollection<MusteriDokuman> MusteriDokumen { get; set; }
        public virtual ICollection<MusteriNot> MusteriNots { get; set; }
        public virtual ICollection<MusteriTelefon> MusteriTelefons { get; set; }
