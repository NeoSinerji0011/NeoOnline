...
{
    public class DubaiXmlReader : IPoliceTransferReader
    {
        ...
        public DubaiXmlReader()
        {
        }

        public DubaiXmlReader(string path, int tvmKodu, List<BransUrun> SigortaSirketiBransList, List<Bran> branslar)
        {
                                    ...
                                    if (polc.Name == "POLICE")
                                    {
                                        ...
                                        for (int gnlbidx = 0; gnlbidx < gnlb.Count; gnlbidx++)
                                        {
                                            ...
                                            if (gnlnode.Name == "DOVIZ_KUR")
                                            {
                                                ...
                                                {
                                                    //var temp = gnlnode.InnerText;
                                                    //temp =temp.Insert(2, ",");
                                                    //police.GenelBilgiler.DovizKur = Convert.ToDecimal(temp); 
                                                    var temp = Convert.ToDecimal(gnlnode.InnerText) / 1000000;
                                                    police.GenelBilgiler.DovizKur = temp;
                                                }
                                            ...
                                            if (gnlnode.Name == "BRANS_ADI") tumUrunAdi = gnlnode.InnerText;
                                            ...
                                            {
                                                police.GenelBilgiler.BrutPrim = Util.ToDecimal(gnlnode.InnerText) * carpan;
                                            }
                                            if (gnlnode.Name == "YTL_NET_PRIM") police.GenelBilgiler.NetPrim = Util.ToDecimal(gnlnode.InnerText) * carpan;
                                            if (gnlnode.Name == "KOMISYON") police.GenelBilgiler.Komisyon = Util.ToDecimal(gnlnode.InnerText) * carpan;
                                            ...
                                            if (gnlnode.Name == "TAKSITLER")
                                            {
                                                ...
                                                for (int idx = 0; idx < taksitlerrnode.Count; idx++)
                                                {
                                                    ...
                                                    if (police.GenelBilgiler.DovizKur != 1 && police.GenelBilgiler.DovizKur != 0 && police.GenelBilgiler.DovizKur != null)
                                                    {
                                                        ...
                                                        {
                                                            odm.DovizliTaksitTutari = Util.ToDecimal(odemenodep["DTUTAR"].InnerText);
                                                        }
                                                    }
                                                    odm.TaksitNo = idx + 1;
                                                    string taksitTuru = odemenodep["HESAP_TIP"].InnerText;
                                                    if (taksitTuru == "KRD")
                                                    {
                                                        odm.OdemeTipi = OdemeTipleri.KrediKarti;
                                                    }
                                                    else if (taksitTuru == "NKT")
                                                    {
                                                    ...
                                                    var tanimliBransOdemeTipleri = _TVMService.GetListTanımliBransTvmSirketOdemeTipleri(tvmkodu, SigortaSirketiBirlikKodlari.DUBAIGROUPSIGORTA, police.GenelBilgiler.BransKodu.Value);
                                                ...
                                                if (taksitlerrnode.Count == 0 && police.GenelBilgiler.BrutPrim.Value != 0)
                                                {
                                                    PoliceOdemePlani odmm = new PoliceOdemePlani();

                                                    if (odmm.TaksitTutari == null && odmm.TaksitNo == 0)
                                                    {
                                                        PoliceGenelBrans PoliceBransEslestir2 = new PoliceGenelBrans();
                                                        PoliceBransEslestir2 = Util.PoliceBransAdiEslestir(_SigortaSirketiBransList, _branslar, tumUrunAdi, tumUrunKodu);
                                            ...
                                            if (gnlnode.Name == "TEMINATLAR")
                                            {
                                                ...
                                                if (police.GenelBilgiler.DovizKur != 0 && police.GenelBilgiler.DovizKur != 1)
                                                {
                                            ...
                                            if (gnlnode.Name == "BILGILER")
                                            {
                                                ...
                                                for (int idxSaha = 0; idxSaha < policeBilgiNodeList.Count; idxSaha++)
                                                {
                                                    ...
                                                    if (saha["BILGI_ADI"].InnerText == "TESCİL TARİH")
                                                    {
                                                        var aciklama = FindNode(saha.ChildNodes, "ACIKLAMA");
                                                    ...
                                                    if (saha["BILGI_ADI"].InnerText == "MARKA")
                                                    {
                                                        ...
                                                        if (aciklama != null)
                                                        {
                                                            police.GenelBilgiler.PoliceArac.Marka = saha["ACIKLAMA"].InnerText;
                                                        }
                                                    }
                                                    ...
                                                    if (saha["BILGI_ADI"].InnerText == "TESCİL NO")
                                                    {
                                                        var aciklama = FindNode(saha.ChildNodes, "ACIKLAMA");
                                                    ...
                                                    if (saha["BILGI_ADI"].InnerText == "PLAKA")
                                                    {
                                                        var aciklama = FindNode(saha.ChildNodes, "ACIKLAMA");
                                                    ...
                                                    if (saha["BILGI_ADI"].InnerText == "SBM TRAMER NO")
                                                    {
                                                        var aciklama = FindNode(saha.ChildNodes, "ACIKLAMA");
                                        ...
                                        police.GenelBilgiler.TUMBirlikKodu = SigortaSirketiBirlikKodlari.DUBAIGROUPSIGORTA;
