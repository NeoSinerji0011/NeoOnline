...
{
    public class TurkiyeXMLReader : IPoliceTransferReader
    {
        ...
        public TurkiyeXMLReader()
        {
        }

        public TurkiyeXMLReader(string path, int tvmKodu, List<BransUrun> SigortaSirketiBransList, List<Bran> branslar)
        {
                                        ...
                                        for (int gnlbidx = 0; gnlbidx < gnlb.Count; gnlbidx++)
                                        {
                                            ...
                                            if (gnlnode.Name == "POLICE_SIGORTA_ETTIREN")
                                            {
                                                ...
                                                for (int idx = 0; idx < sigortaEttirenNodes.Count; idx++)
                                                {
                                                    ...
                                                    if (sigortaEttirenNode.Name == "ILCE") police.GenelBilgiler.PoliceSigortaEttiren.IlceKodu = Util.toInt(sigortaEttirenNode.InnerText);
                                            ...
                                            if (gnlnode.Name == "POLICE_SIGORTALI")
                                            {
                                                ...
                                                for (int idx = 0; idx < sigortalilarNode.Count; idx++)
                                                {
                                                    ...
                                                    if (sigortaliNode.Name == "ILCE") police.GenelBilgiler.PoliceSigortali.IlceKodu = Util.toInt(sigortaliNode.InnerText);
                                            ...
                                            if (gnlnode.Name == "BILGILER")
                                            {
                                                ...
                                                for (int idxSaha = 0; idxSaha < policeBilgiNodeList.Count; idxSaha++)
                                                {
                                                    ...
                                                    if (saha["BILGI_ADI"].InnerText == "TESCIL SIRA :")
                                                    {
                                                        var aciklama = FindNode(saha.ChildNodes, "ACIKLAMA");
