...
{
    [Serializable]
    public class PR_SWEP_URT_OTO_WS_KASKO_TEKLIF_POLICELENDIR : ANADOLUMessage
    {
        public PR_SWEP_URT_OTO_WS_KASKO_TEKLIF_POLICELENDIR()
        {
        ...
        {
            return base.GetSoapAction() + "PR_SWEP_URT_OTO_WS_KASKO_TEKLIF_POLICELENDIR";
        }

        public override string GetMessageBody()
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("<cms:PR_SWEP_URT_OTO_WS_KASKO_TEKLIF_POLICELENDIR>");
            ...
            sb.Append(MsgParameter("CVV2", this.ARAC_RENGI));
            sb.Append(MsgParameter("KART_TEL_NO", this.KART_TEL_NO));
            sb.Append(MsgParameter("KART_TEL_ALAN", this.KART_TEL_ALAN));
            sb.Append(MsgParameter("ILETISIM_CIHAZ_LISTESI", this.ILETISIM_CIHAZ_LISTESI));
            sb.Append(MsgParameter("SES_CIHAZ_LISTESI", this.SES_CIHAZ_LISTESI));
            ...
            sb.Append(MsgParameter("GORUNTU_CIHAZ_LISTESI", this.GORUNTU_CIHAZ_LISTESI));
            ...
            sb.Append(MsgParameter("RETURN_BILGILENDIRME_FORMU_PDF", this.RETURN_GENEL_SART_PDF));
        ...
        public string ILETISIM_CIHAZ_LISTESI { get; set; }
        public string SES_CIHAZ_LISTESI { get; set; }
        ...
        public string GORUNTU_CIHAZ_LISTESI { get; set; }
