...
{
    [Serializable]
    public class PR_SWEP_URT_OTO_WS_GET_WEB_KULLANIM_TIPI_LISTESI_Response : ANADOLUMessage
    {
        public override void ReadXml(string xml, string name)
        {
            base.ReadXml(xml, "PR_SWEP_URT_OTO_WS_GET_WEB_KULLANIM_TIPI_LISTESI_Response");
