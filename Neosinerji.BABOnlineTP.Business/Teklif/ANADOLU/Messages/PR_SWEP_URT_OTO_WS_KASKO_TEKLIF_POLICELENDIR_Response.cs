...
{
    public class PR_SWEP_URT_OTO_WS_KASKO_TEKLIF_POLICELENDIR_Response : ANADOLUMessage
    {
        public override void ReadXml(string xml, string name)
        {
            base.ReadXml(xml, "PR_SWEP_URT_OTO_WS_KASKO_TEKLIF_POLICELENDIR_Response");
