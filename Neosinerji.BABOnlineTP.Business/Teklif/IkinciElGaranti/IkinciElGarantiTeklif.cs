...
{
    public class IkinciElGarantiTeklif : TeklifBase, IIkinciElGarantiTeklif
    {
        public IkinciElGarantiTeklif()
            : base()
        {

        }

        public IkinciElGarantiTeklif(int teklifId)
            : base(teklifId)
        {
        ...
        public override IsDurum Hesapla(ITeklif teklif)
        {
            ...
            if (anadolu)
            {
                ...
                {
                    IANADOLUIkinciElGaranti ikinciElGaranti = DependencyResolver.Current.GetService<IANADOLUIkinciElGaranti>();
                    ikinciElGaranti.OdemePlaniAlternatifKodu = odemePlaniAlternatifKodu;
                    this.AddTeklif(ikinciElGaranti);
                }
            }
        ...
        public void CreatePolicePDF(ITeklif teklif)
        {
            ...
            //    pdf = new PDFHelper("Babonline", "SEYAHAT SAĞLIK SİGORTASI POLİÇESİ", "SEYAHAT SAĞLIK SİGORTASI POLİÇESİ", 8, _RootPath + "Content/fonts/");
            //    PDFParser parser = new PDFParser(template, pdf);
        ...
        public override void EPostaGonder(string DigerAdSoyad, string DigerEmail)
        {
            ...
            email.SendIkinciElGarantiTeklif(this.Teklif, DigerAdSoyad, DigerEmail);
        }
