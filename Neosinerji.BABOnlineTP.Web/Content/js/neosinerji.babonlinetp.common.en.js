        ...
        */
        UAVTSorgu: function (options) {
            ...
            $(options.Mahalle).change(function () {
                ...
                $.getJSON("/Teklif/Dask/GetListCadSkBulMeydan", { MahalleKodu: MahalleKodu }, function (result) {
            ...
            $(options.CaddeSokakBulvar).change(function () {
                ...
                $.getJSON("/Teklif/Dask/GetListCadSkBulMeydan_BinaAd", { CadSkBulMeyKodu: CaddeSokakBulvarKodu }, function (result) {
