$(document).ready(function () {
    ...
    $("#paritus-dogrula").click(function () {
        ...
        var adres = $("#PotansiyelMusteriAdresModel_ParitusAdresDogrulama").val();
        if (adres != "") {
                    ...
                    200: function (data) {
                        if (data.Durum == 0) {
                            ...
                            if (data.Iller != null) {
                                ...
                                $("#PotansiyelMusteriAdresModel_IlKodu").empty();
                                $("#PotansiyelMusteriAdresModel_IlKodu").dropDownFill(data.Iller);
                                $("#PotansiyelMusteriAdresModel_IlKodu").val(data.IlKodu);

                                if (data.IlceLer != null) {
                                    $("#PotansiyelMusteriAdresModel_IlceKodu").empty();
                                    $("#PotansiyelMusteriAdresModel_IlceKodu").dropDownFill(data.IlceLer);
                                    $("#PotansiyelMusteriAdresModel_IlceKodu").val(data.IlceKodu);
                                }
                            }

                            $(".paritus-adres").val("");

                            $("#PotansiyelMusteriAdresModel_Adres").val(data.FullAdres);
                            $("#PotansiyelMusteriAdresModel_Mahalle").val(data.Mahalle);
                            $("#PotansiyelMusteriAdresModel_Cadde").val(data.Cadde);
                            $("#PotansiyelMusteriAdresModel_Sokak").val(data.Sokak);
                            $("#PotansiyelMusteriAdresModel_DaireNo").val(data.DaireNo);
                            $("#PotansiyelMusteriAdresModel_BinaNo").val(data.BinaNo);
                            $("#PotansiyelMusteriAdresModel_PostaKodu").val(data.PostaKodu);
                            $("#PotansiyelMusteriAdresModel_Apartman").val(data.Apartman);
                            ...
                            $("#PotansiyelMusteriAdresModel_Diger").val(diger);
    ...
    $("#tablebodycommendation").on('click', 'td', function () {
        var t = $(this).text();
        $("#PotansiyelMusteriAdresModel_ParitusAdresDogrulama").val(t);
    });

    $("#ornek").click(function () {
        $("#PotansiyelMusteriAdresModel_ParitusAdresDogrulama").val("Hasanpaşa Mh. Yeniyol Sk. Etap İş Mrkz. C Blok Kat:4 Daire:12 Kadıköy İSTANBUL");
    });

    $("#temizle").click(function () {
        $("#PotansiyelMusteriAdresModel_ParitusAdresDogrulama").val("");
    ...
    return {
        ...
        HaritadaGoster: function (latitude, longitude) {
            ...
            if (latitude != "" && longitude != "") {
                ...
                $("#PotansiyelMusteriAdresModel_Latitude").val(latitude);
                $("#PotansiyelMusteriAdresModel_Longitude").val(longitude);
