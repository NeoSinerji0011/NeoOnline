...
(function ($, window, document) {
    ...
    TableTools.prototype = {
        ...
        "_fnButtonBase": function (o, bCollectionButton) {
            ...
            //nButton.className =  o.sButtonClass;
            nButton.setAttribute('id', "ToolTables_" + this.s.dt.sInstance + "_" + masterS.buttonCounter);
            nButton.setAttribute('style', "margin:0px !important; padding: 0 0 0 3px !important; background-color: transparent;");


            if (o.sAction == "flash_pdf") {
                sIcon.setAttribute("src", "/content/img/pdf-icon-big.png");
                sIcon.setAttribute("alt", "pdf");
                nButton.setAttribute('title', "Pdf'e Aktar");
            }
            else if (o.sAction == "text") {
                sIcon.setAttribute("src", "/content/img/Devices-printer-icon.png");
                sIcon.setAttribute("alt", "Yazdır");
                nButton.setAttribute('title', "Yazdır");
            }
            else if (o.sAction == "flash_save") {
                sIcon.setAttribute("src", "/content/img/Excel-icon.png");
                sIcon.setAttribute("alt", "excel");
                nButton.setAttribute('title', "Excel'e Aktar");
            }
            else if (o.sAction == "flash_copy") {
                sIcon.setAttribute("src", "/content/img/Files-Copy-File-icon.png");
                sIcon.setAttribute("alt", "kopyala");
                nButton.setAttribute('title', "Kopyala");
            }
            nButton.appendChild(sIcon);
            sIcon.innerHTML = "&nbsp;";
    ...
    TableTools.BUTTONS = {
        ...
        "copy": $.extend({}, TableTools.buttonBase, {
            ...
            "fnComplete": function (nButton, oConfig, flash, text) {
                var
                    ...
                    plural = (len == 1) ? "" : "s";
                this.fnInfo('<h6>Tablo Kopyalandı</h6>' +
                    '<p>' + len + ' satır kopyalandı.</p>',
                    1500
                );
            }
        }),
        ...
        //}),
        "print": $.extend({}, TableTools.buttonBase, {
            "sInfo": "<h6>Yazdırma Ekranı</h6><p>Lütfen tarayıcınızın yazdırma tuşunu kullanarak " +
              "bu sayfayı yazdırın. Sonrasında escape (esc) tuşu ile çıkın.",
            "sMessage": null,
            "bShowAll": true,
            "sToolTip": "Yazdır",
            "sButtonClass": "DTTT_button_print",
     ...
     */
    TableTools.DEFAULTS = {
        "sSwfPath": "/Content/templates/copy_csv_xls_pdf.swf",
        "sRowSelect": "none",
        "sSelectedClass": null,
        "fnPreRowSelect": null,
        "fnRowSelected": null,
