...
(function ($) {
    ...
    var options = {
        ...
        minChar: 6,
        errorMessages: {
            password_to_short: "Şifreniz Çok Kısa!", //"The Password is too shortııı",
            same_as_username: "Şifreniz İsminizle Aynı Olamaz",// "Your password cannot be the same as your username"
        },
        scores: [17, 26, 40, 50],
