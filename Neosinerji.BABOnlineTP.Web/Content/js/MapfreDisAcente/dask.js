    ...
    return {
        YururluktePolice: function (e, data) {
            if (data.value) {
                ...
                DaskGenelBilgiler.AddClassIgnore();
            }
            else {
                ...
                DaskGenelBilgiler.RemoveClassIgnore();
            }
        },
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data.HataMesaji != "" && data.HataMesaji != null) {
                            ...
                            var adres = data.MahalleAdi + " ";
                            adres += data.CaddeAdi;
                            adres += "No.:" + data.BinaNo + " / ";
                            adres += data.DaireNo + " ";
                            adres += data.IlAdi + " ";
                            adres += data.IlceAdi + " ";
                            adres += data.BeldeAdi + " ";
                            adres += " | UAVT Kodu : " + data.UATVKodu;

                            $("#adres-text").html(adres);
                            $("#adres-info").addClass("in");
                            $("#adres-info").attr("style", "display:normal");
                            $("#RizikoAdresBilgiler_UATVKodu").val(data.UATVKodu);
                            $("#RizikoAdresBilgiler_ParitusAdresDogrulama").val(data.UATVKodu);

                            $("#RizikoDigerBilgiler_Parsel").val(data.Parsel);
                            $("#RizikoDigerBilgiler_PaftaNo").val(data.Pafta);
                            $("#RizikoDigerBilgiler_Ada").val(data.Ada);
                            $("#RizikoDigerBilgiler_SayfaNo").val(data.SayfaNo);

                            if (data.IlKodu != "") {
                                $("#RizikoAdresBilgiler_IlKodu").val(data.IlKodu).trigger("liszt:updated");
                            }
                            if (data.IlceKodu != null) {
                            ...
                            if (data.SemtBeldeKodu != null) {
                                ...
                                $("#RizikoAdresBilgiler_SemtBeldeKodu").val(data.SemtBeldeKodu).trigger("liszt:updated");
                            }
                            if (data.MahalleKodu != null) {
                                $("#RizikoAdresBilgiler_MahalleKodu").empty().trigger("liszt:updated");
                                $("#RizikoAdresBilgiler_MahalleKodu").dropDownFill(data.Mahalleler);
                                $("#RizikoAdresBilgiler_MahalleKodu").val(data.MahalleKodu).trigger("liszt:updated");
                            }
                            if (data.CaddeKodu != null) {
                                $("#RizikoAdresBilgiler_CaddeKodu").empty().trigger("liszt:updated");
                                $("#RizikoAdresBilgiler_CaddeKodu").dropDownFill(data.Caddeler);
                                $("#RizikoAdresBilgiler_CaddeKodu").val(data.CaddeKodu).trigger("liszt:updated");
                            }
                            if (data.BinaKodu != null) {
                                $("#RizikoAdresBilgiler_BinaKodu").empty().trigger("liszt:updated");
                                $("#RizikoAdresBilgiler_BinaKodu").dropDownFill(data.Binalar);
                                $("#RizikoAdresBilgiler_BinaKodu").val(data.BinaKodu).trigger("liszt:updated");
                            }
                            if (data.DaireKodu != null) {
                                $("#RizikoAdresBilgiler_DaireKodu").empty().trigger("liszt:updated");
                                $("#RizikoAdresBilgiler_DaireKodu").dropDownFill(data.Daireler);
                                $("#RizikoAdresBilgiler_DaireKodu").val(data.DaireKodu).trigger("liszt:updated");
                            }
                            $("#RizikoDigerBilgiler_DaireBrutYuzolcumu").val(data.policeBilgi.DaireM2);
                            $("#RizikoDigerBilgiler_YapiTarzi").val(data.policeBilgi.BinaInsaTarzi);
                            $("#RizikoDigerBilgiler_BinaInsaYili").val(data.policeBilgi.BinaInsaYili);
                            $("#RizikoDigerBilgiler_BinaKatSayisi").val(data.policeBilgi.BinaninToplamKatSayisi);
                            $("#RizikoDigerBilgiler_SigortaEttirenSifati").val(data.policeBilgi.SigortaEttirenSifati);
                            $("#RizikoDigerBilgiler_DaireKullanimSekli").val(data.policeBilgi.DaireKullanimSekli);
                            if (data.policeBilgi.HasarliMi == 0) {
                                $("#RizikoDigerBilgiler_HasarDurumu").val("1");
                            }
                            else if (data.policeBilgi.HasarliMi == 1) {
                                $("#RizikoDigerBilgiler_HasarDurumu").val("2");
                            }

                            if (data.policeBilgi.DainiMurteinVarMi == "E") {
                                $("#RizikoGenelBilgiler_RehinliAlacakliDainMurtehinVarmi_control").bootstrapSwitch('setState', true);
                                $("#RizikoGenelBilgiler_KrediTutari").val(data.policeBilgi.DainiMurteinKrediTutari);
                                $("#RizikoGenelBilgiler_KrediReferansNo_HesapSozlesmeNo").val(data.policeBilgi.DainiMurteinKrediSozlesmeNo);
                                $("#RizikoGenelBilgiler_KrediBitisTarihi").val(data.policeBilgi.DainiMurteinKrediBitisTar);
                            }
                            else {
        ...
        UATVKoduSorgula: function (UavtKodu) {
            $.getJSON("/Teklif/Dask/GetUAVTAdres", { UavtKodu: UavtKodu }, function (result) {
                ...
                var adres = result.MahalleAdi + " ";
                adres += result.CaddeAdi + " " + result.SokakAdi;
                adres += result.BinaNo + " / ";
                adres += result.DaireNo + " ";
                adres += result.IlAdi + " ";
                adres += result.IlceAdi + " ";
                adres += result.BeldeAdi + " ";
        ...
        AddClassIgnore: function () {
            $("#RizikoAdresBilgiler_IlKodu").addClass("ignore");
            $("#RizikoAdresBilgiler_IlKodu_chzn").addClass("ignore");
            $("#RizikoAdresBilgiler_IlceKodu").addClass("ignore");
            $("#RizikoAdresBilgiler_SemtBeldeKodu").addClass("ignore");
            $("#RizikoAdresBilgiler_MahalleKodu").addClass("ignore");
            $("#RizikoAdresBilgiler_CaddeKodu").addClass("ignore");
            $("#RizikoAdresBilgiler_BinaKodu").addClass("ignore");
            $("#RizikoAdresBilgiler_DaireKodu").addClass("ignore");
            $("#RizikoAdresBilgiler_PostaKodu").addClass("ignore");
            $("#RizikoDigerBilgiler_YapiTarzi").addClass("ignore");
            $("#RizikoDigerBilgiler_BinaInsaYili").addClass("ignore");
            $("#RizikoDigerBilgiler_HasarDurumu").addClass("ignore");
            $("#RizikoDigerBilgiler_Parsel").addClass("ignore");
            $("#RizikoDigerBilgiler_PaftaNo").addClass("ignore");
            $("#RizikoDigerBilgiler_Ada").addClass("ignore");
            $("#RizikoDigerBilgiler_BinaKatSayisi").addClass("ignore");
            $("#RizikoDigerBilgiler_DaireKullanimSekli").addClass("ignore");
            $("#RizikoDigerBilgiler_SigortaEttirenSifati").addClass("ignore");
            $("#RizikoDigerBilgiler_KatNo").addClass("ignore");
            $("#RizikoDigerBilgiler_SayfaNo").addClass("ignore");
            $("#RizikoDigerBilgiler_DaireBrutYuzolcumu").addClass("ignore");
            $("#RizikoAdresBilgiler_UATVKodu").addClass("ignore");
            $(".eski-police-sorgu").addClass("ignore");
           
        },
        RemoveClassIgnore: function () {
            $("#RizikoAdresBilgiler_IlKodu").removeClass("ignore");
            $("#RizikoAdresBilgiler_IlceKodu").removeClass("ignore");
            $("#RizikoAdresBilgiler_SemtBeldeKodu").removeClass("ignore");
            $("#RizikoAdresBilgiler_MahalleKodu").removeClass("ignore");
            $("#RizikoAdresBilgiler_CaddeKodu").removeClass("ignore");
            $("#RizikoAdresBilgiler_BinaKodu").removeClass("ignore");
            $("#RizikoAdresBilgiler_DaireKodu").removeClass("ignore");
            $("#RizikoAdresBilgiler_PostaKodu").removeClass("ignore");
            $("#RizikoDigerBilgiler_YapiTarzi").removeClass("ignore");
            $("#RizikoDigerBilgiler_BinaInsaYili").removeClass("ignore");
            $("#RizikoDigerBilgiler_HasarDurumu").removeClass("ignore");
            $("#RizikoDigerBilgiler_Parsel").removeClass("ignore");
            $("#RizikoDigerBilgiler_PaftaNo").removeClass("ignore");
            $("#RizikoDigerBilgiler_Ada").removeClass("ignore");
            $("#RizikoDigerBilgiler_BinaKatSayisi").removeClass("ignore");
            $("#RizikoDigerBilgiler_DaireKullanimSekli").removeClass("ignore");
            $("#RizikoDigerBilgiler_SigortaEttirenSifati").removeClass("ignore");
            $("#RizikoDigerBilgiler_KatNo").removeClass("ignore");
            $("#RizikoDigerBilgiler_SayfaNo").removeClass("ignore");
            $("#RizikoDigerBilgiler_DaireBrutYuzolcumu").removeClass("ignore");
            $("#RizikoAdresBilgiler_UATVKodu").removeClass("ignore");
        },
...
function daskTeklifWizardCallback(current) {
    ...
    //Sigorta ettiren / sigortali tab
        ...
        //if ($("#Musteri_SigortaEttiren_CepTelefonu").val() == "")
        //    return 0;
        //else {
...
$("#uavt-sorgula").click(function () {
    $("#uavt-sorgula").button("loading");
    var uavtKodu = $("#RizikoAdresBilgiler_ParitusAdresDogrulama").val();
    if (uavtKodu != "") {
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "/Teklif/Dask/GetUAVTAdresDetay",
            data: { UAVTAdresKodu: uavtKodu },
            success: function (data) {
                if (data.HataMesaji != "" && data.HataMesaji != null) {
                    $("#uavt-sorgula").button("reset");
                    ParitusHelper.AdresTemizle();
                    swal("Hata!", data.HataMesaji);
                }
                else {
