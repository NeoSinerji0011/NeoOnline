        ...
        initDaterange: function (startDate, endDate) {
            ...
            $('#dashboard-report-range').daterangepicker({
                ranges: {
                    'Oggi': ['Oggi', 'Oggi'],
                    'Ieri': ['Ieri', 'Ieri'],
                    'Ultimi 7 giorni': [Date.today().add({ days: -6 }), 'oggi'],
                    'Negli ultimi 30 giorni': [Date.today().add({ days: -29 }), 'oggi'],
                    'Questo mese': [Date.today().moveToFirstDayOfMonth(), Date.today().moveToLastDayOfMonth()],
                    'Ultimo mese': [Date.today().moveToFirstDayOfMonth().add({ months: -1 }), Date.today().moveToFirstDayOfMonth().add({ days: -1 })]
                },
                ...
                locale: {
                    ...
                    fromLabel: 'From',
                    toLabel: 'To',
                    customRangeLabel: 'data personalizzata',
                    daysOfWeek: ['Domenica', 'Lunedì', 'Martedì', 'Mercoledì', 'Giovedì', 'Venerdì', 'Sabato'],
                    monthNames: ['Gennaio', 'Febbraio', 'marzo', 'Aprile', 'Maggio', 'giu', 'Luglio', 'Agosto', 'Settembre', 'ottobre', 'Novembre', 'Dicembre'],
                    firstDay: 1
                },
