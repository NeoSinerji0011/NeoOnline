...
{
    public class EPostaAdresiAttribute : DataTypeAttribute, IClientValidatable 
    {
        ...
        public EPostaAdresiAttribute()
            : base(DataType.EmailAddress) 
        {
            ErrorMessage = BABOnlineTP.Web.Content.Lang.babonline.Message_Email;
        }
        ...
        {
            yield return new EPostaAdresiClientValidationRule(ErrorMessage);
        }
