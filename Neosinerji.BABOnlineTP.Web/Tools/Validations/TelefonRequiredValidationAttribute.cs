...
namespace Neosinerji.BABOnlineTP.Web.Tools
{
    ...
    public class TelefonRequiredValidationAttribute : ValidationAttribute, IClientValidatable
    {
        public override bool IsValid(object value)
        {
            ...
            if (value is TelefonModel && value != null)
            {
                ...
                if (!String.IsNullOrEmpty(model.UluslararasiKod) && model.UluslararasiKod.Length > 0 &&
        ...
        {
            var rule = new TelefonRequiredClientValidationRule(BABOnlineTP.Web.Content.Lang.babonline.Message_PhoneNumber);
            yield return rule;
        }
    }
